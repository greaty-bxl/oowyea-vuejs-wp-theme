		...
		this.$emit('template_mounted', this);
			...
			'.title-home' : 25,
				...
				setTimeout(function() {
					...
					$('#pick_date').attr('min', '2020-27-11');
					$('#pick_date').attr('max', '2024-01-02');
...
@import url('https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;1,100;1,200;1,300;1,400&display=swap');
	...
	#pick_date .picker__date-display {
	background-color:red !important;
	}
	#pick_date .picker__weekday-display {
	background-color:red !important;
	}
	#pick_date .picker__day--selected, .picker__day--selected:hover, .picker--focused .picker__day--selected {
	background-color:red !important;
	}
